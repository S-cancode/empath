...
- **Remaining in Wave 2**: Phase 4 authorization matrix (participant checks on all socket/REST/live-session events, match:decline fix, crisis-after-authz, arbitrary-ID negative tests).
